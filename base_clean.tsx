...
const PROJECTS = [
  {
    ...
    status: 'En venta',
    category: 'En venta',
    description: 'Viviendas modernas en una ubicaci├│n privilegiada. Un procedimiento seguro y confiable.',
    fullDescriptionHtml: `
<p class="mb-4">Venta desde el pozo de dos espectaculares d├║plex ubicados sobre la importante Av. 91 entre las calles 42 y 40.</p>
      <p class="mb-4">Un lugar privilegiado a pocas cuadras del m├ígico parque Miguel Lillo, en Necochea, Prov. de Buenos Aires.</p>
      <h3 class="text-xl font-bold text-gray-100 mt-8 mb-3">Detalles</h3>
      <ul class="list-disc pl-5 mb-4 space-y-2">
        <li><strong>Ubicaci├│n:</strong> Av. 91 N┬░ 1781 e/ 87 y 85.</li>
        ...
        <li><strong>Ba├▒os:</strong> 1 principal + 1 de servicio cada uno.</li>
      </ul>
      <p class="font-bold text-[#f27d26] mt-6">Costos de mantenimiento: sin expensas.</p>
    `,
    features: ['3 ambientes con balc├│n', 'Doble cochera', 'Patio propio', 'Financiaci├│n del 70%'],
    financing: ['Descuentos por pago en efectivo', 'Costos de escrituraci├│n incluidos', 'Sin comisiones inmobiliarias'],
...
<h3 class="text-xl font-bold text-gray-100 mb-3">Departamentos a estrenar</h3>
      <p class="mb-4">Balc├│n a la avenida. Cerca del parque Miguel Lillo y de la playa.</p>
      <ul class="list-disc pl-5 mb-4 space-y-2">
      ...
      <p class="font-bold text-[#f27d26] mt-6">Costos de mantenimiento: sin expensas.</p>
    `,
    features: ['Departamentos de 1, 2 y 3 ambientes Adaptables', 'Cocheras Disponibles', 'Patio propio', 'Dise├▒o funcional'],
    financing: ['Financiaci├│n en hasta 48 cuotas', 'Posesi├│n inmediata'],
  ...
  },
  {
    ...
    description: 'Proyecto de vanguardia con unidades funcionales y dise├▒o contempor├íneo.',
    fullDescriptionHtml: `
<p class="mb-4">Presentamos <strong>┬½Ares 22┬╗</strong>, una aut├®ntica joya del sector inmobiliario a 7 cuadras de la playa de NECOCHEA. Este proyecto representa una oportunidad ├║nica para inversores con una visi├│n prospectiva.</p>
      <h3 class="text-xl font-bold text-gray-100 mt-8 mb-3">Rentabilidad Asegurada</h3>
      <p class="mb-4">┬½Ares 22┬╗ combina excelencia y rentabilidad. Con departamentos de dos ambientes y nueve cocheras disponibles, esta es una oportunidad inmejorable para ingresar al mercado inmobiliario con ├®xito garantizado.</p>
      <h3 class="text-xl font-bold text-gray-100 mt-8 mb-3">FINANCIACI├ôN EXCLUSIVA DESDE EL POZO</h3>
      <p class="mb-4">Solo por esta oportunidad, con tan solo una <strong>RESERVA DEL 20%</strong> pod├®s adquirir tu unidad mas una financiaci├│n de hasta <strong style="color: #f27d26; font-size: 1.3em;">120 CUOTAS</strong> en <strong>PESOS</strong>.</p>
      <h3 class="text-xl font-bold text-gray-100 mt-8 mb-3">Ubicaci├│n Estrat├®gica</h3>
      <p class="mb-4">Situado en la calle 22, entre las calles 77 y 79, este proyecto se encuentra a tan solo tres cuadras y media de la vital Avenida 10, que representa el principal corredor peatonal de la ciudad y a 7 cuadras de la playa. Aprovechando el crecimiento din├ímico hacia la costa, este desarrollo atrae tanto a turistas como a residentes locales.</p>
      <h3 class="text-xl font-bold text-gray-100 mt-8 mb-3">Dise├▒o y Calidad</h3>
      <p class="mb-4">Ofrecemos departamentos de m├ís de 45 m┬▓, cada uno con balcones orientados tanto al frente como al contrafrente, adem├ís de cocheras y servicios esenciales como agua, cloacas, electricidad y gas. Tu inversi├│n se traduce en comodidad y funcionalidad.</p>
      <p class="font-bold text-[#f27d26] mt-6">Costos de mantenimiento: sin expensas.</p>
    `,
    ...
    financing: ['Financiaci├│n hasta <strong style="color:#f27d26;font-size:1.4em;">120 CUOTAS</strong> en <strong>PESOS</strong>', 'Financiaci├│n directa sin intermediarios', 'Fideicomiso al costo'],
    videos: {
  ...
  },
  {
    ...
    fullDescriptionHtml: `
<p class="mb-4">Una joya inmobiliaria en el coraz├│n de NECOCHEA.</p>
      <p class="mb-4">Ubicado estrat├®gicamente en la vibrante ciudad, este proyecto es una oportunidad excepcional para inversores visionarios.</p>
      <p class="mb-4"><strong>┬½Delfos 83┬╗</strong> ofrece calidad y rentabilidad. Con departamentos de 1, 2 y 3 ambientes con patios propios, balcones al frente y cocheras, esta es tu oportunidad de entrar al mercado inmobiliario con ├®xito asegurado.</p>
      <p class="mb-4">En plena calle 83 entre calles 24 y 26 se emplaza a solo 3 cuadras y media de la important├¡sima Av. 10, la cual es el sendero peatonal mas importante de la cuidad. Este proyecto aprovecha el crecimiento din├ímico de la ciudad hacia la playa en donde capta justo el publico tur├¡stico como el local.</p>
      <p class="font-bold text-[#f27d26] mt-6">Costos de mantenimiento: sin expensas.</p>
    `,
    features: ['Entrega noviembre del 2026', 'Ubicaci├│n privilegiada', 'Financiaci├│n en 48 cuotas en <strong>PESOS</strong>'],
    financing: ['Financiaci├│n en hasta 48 cuotas', 'Venta desde el pozo'],
  ...
  },
  {
    ...
    fullDescriptionHtml: `
<h3 class="text-xl font-bold text-gray-100 mb-3">En Venta - Posesi├│n inmediata</h3>
      <ul class="list-disc pl-5 mb-4 space-y-2">
        <li>Todos los servicios.</li>
        <li>Unidad a estrenar sin expensas.</li>
        <li>Terreno de 5 por 30 metros de largo, listo para escriturar, subdivisi├│n y reglamento terminados.</li>
        <li>Entrada para dos veh├¡culos chicos o camioneta.</li>
      ...
      <ul class="list-disc pl-5 mb-4 space-y-2">
        ...
        <li>Ba├▒o completo con ba├▒era.</li>
    ...
    `,
    features: ['Espacios verdes', 'Alta luminosidad y ventilaci├│n', 'Calidad constructiva premium'],
    financing: ['Financiaci├│n flexible', 'Adaptable a ingresos medios'],
  ...
  },
  {
    ...
    status: 'Finalizado',
    category: 'Finalizados',
    description: 'Solidez y dise├▒o en un proyecto ya entregado y consolidado.',
    fullDescriptionHtml: `
<p class="mb-4"><strong>Zeus 543</strong> es el primer emprendimiento que realizamos sobre la calle 543 entre Av. Loberia y 580.</p>
      <p class="mb-4">Se emplaz├│ en un lote de 10├ù40 un departamento de 2 ambientes y un d├║plex de 110 m┬▓ cubiertos con entradas dobles vehiculares y patios propios.</p>
...
const Layout = ({ children }: { children: React.ReactNode }) => {
  ...
  const navLinks = [
    ...
    { name: 'Financiaci├│n', path: '/financiacion' },
      ...
      <footer className="bg-[#4a4a4a] text-gray-100 pt-32 pb-16 border-t border-gray-700">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-12 gap-16 mb-24">
            <div className="md:col-span-5">
              ...
              <p className="text-gray-400 max-w-sm text-lg font-medium leading-relaxed mb-10">
                Desarrollamos el futuro de Necochea con una visi├│n arquitect├│nica que prioriza la calidad, el dise├▒o y la rentabilidad de nuestros inversores.
              </p>
            ...
            <div className="md:col-span-2">
              <p className="text-[#f27d26] text-[10px] uppercase tracking-[0.2em] font-semibold mb-8">Navegaci├│n</p>
          ...
          <div className="pt-8 border-t border-gray-700 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-500 font-medium">
            ...
            <div className="flex gap-6">
              <a href="#" className="hover:text-[#f27d26] transition-colors">T├®rminos y Condiciones</a>
              <a href="#" className="hover:text-[#f27d26] transition-colors">Pol├¡tica de Privacidad</a>
            </div>
          </div>
        </div>
      </footer>
...
const Home = () => {
  ...
  const carouselItems = [
    ...
    {
      name: 'Nueva Fachada',
      features: ['Dise├▒o minimalista', 'Ubicaci├│n premium', 'Vistas panor├ímicas'],
      image: '/optimized/Copia-de-Nueva-Fachada.webp'
    },
    {
      name: 'Orfeo',
      features: ['Entrega inmediata', 'Calidad Apolo', 'Dise├▒o funcional'],
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 flex flex-col items-center justify-center h-full text-center px-5 max-w-5xl mx-auto pt-24 md:pt-32">
          ...
          >
            ...
            >
              Departamentos y Emprendimientos en Pozo ÔÇö Necochea
            </motion.p>
          ...
          >
            <div className="relative">
              ...
              <div className="absolute -bottom-8 -right-8 w-44 h-52 bg-[#4a4a4a] shadow-2xl border border-gray-800 p-8 flex flex-col justify-end hidden md:flex rounded-3xl">
                ...
                <p className="text-gray-500 text-xs uppercase tracking-widest mt-2">A├▒os de Excelencia</p>
              </div>
            </div>
            <div>
              ...
              <p className="text-lg text-gray-400 mb-6 leading-relaxed font-medium">
                En Apolo Construcciones, no solo edificamos estructuras; creamos hogares y oportunidades de inversi├│n que perduran. Nuestra filosof├¡a se basa en la honestidad, la calidad constructiva y el respeto por el entorno.
              </p>
              <p className="text-lg text-gray-400 mb-10 leading-relaxed font-medium">
                Cada proyecto es una pieza ├║nica de arquitectura contempor├ínea, dise├▒ada para maximizar el confort y la rentabilidad de nuestros clientes en Necochea.
              </p>
    ...
    <div className="pt-32 pb-24 bg-[#3b3b3b] min-h-screen">
      <div className="max-w-7xl mx-auto px-6">
        <div className="max-w-3xl mb-24">
          <p className="text-[#f27d26] text-[10px] uppercase tracking-[0.2em] font-semibold mb-6">Inversi├│n y Resguardo</p>
          <h1 className="text-6xl md:text-8xl mb-8 leading-tight tracking-tighter font-bold font-sans text-gray-100">
            Opciones de <br /><span className="text-[#f27d26] font-bold">Financiaci├│n.</span>
          </h1>
          <p className="text-xl text-gray-400 font-medium leading-relaxed">
            Facilitamos el camino hacia tu nuevo hogar con opciones flexibles y seguras, dise├▒adas para el inversor.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            ...
            <p className="text-gray-400 text-lg mb-12 leading-relaxed font-medium">
              Financiaci├│n directa con Apolo Construcciones. Planes adaptados a tu medida para que puedas invertir con tranquilidad y previsibilidad.
            </p>
            <div className="space-y-6 mb-16 flex-grow">
              <div className="flex items-start gap-4 font-medium text-gray-300 bg-[#2A2A2A]/50 p-3 rounded-lg">
                ...
                <span>Cuotas fijas en <strong>PESOS</strong> o d├│lares</span>
              </div>
              <div className="flex items-start gap-4 font-medium text-gray-300 bg-[#2A2A2A]/50 p-3 rounded-lg">
                <Check className="w-5 h-5 text-[#22c55e] shrink-0 mt-0.5" />
              ...
              <div className="flex items-start gap-4 font-medium text-gray-300 bg-[#2A2A2A]/50 p-3 rounded-lg">
                <Check className="w-5 h-5 text-[#22c55e] shrink-0 mt-0.5" />
                <span>Posesi├│n inmediata en obras finalizadas</span>
              </div>
            </div>
          ...
          >
            ...
            <p className="text-[#f27d26] text-[10px] uppercase tracking-[0.2em] font-semibold mb-8">Plan Ares 22 ÔÇö Exclusivo</p>
            ...
            <p className="text-gray-400 text-lg mb-12 leading-relaxed font-medium">
              Plan exclusivo para el proyecto Ares 22. Financiaci├│n a 10 a├▒os en pesos con fideicomiso al costo. La mejor oportunidad de inversi├│n inmobiliaria.
            </p>
            <div className="space-y-6 mb-16 flex-grow">
              ...
              <div className="flex items-start gap-4 font-medium text-gray-200 bg-[#f27d26]/10 p-3 rounded-lg border border-[#f27d26]/20">
                <Check className="w-5 h-5 text-[#f27d26] shrink-0 mt-0.5" />
                <span>Financiaci├│n directa sin intermediarios</span>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <div>
            ...
            <p className="text-xl text-gray-400 mb-8 leading-relaxed font-medium">
              En Apolo Construcciones, no solo levantamos paredes; creamos espacios donde las familias construyen su futuro. Con m├ís de 15 a├▒os en el mercado de Necochea, nos hemos consolidado como referentes en calidad y cumplimiento.
            </p>
            <div className="grid grid-cols-2 gap-8">
              <div>
                <div className="text-5xl font-bold text-[#f27d26] mb-2">+15</div>
                <div className="text-gray-400 text-[10px] uppercase tracking-[0.2em] font-semibold">A├▒os de trayectoria</div>
              </div>
              <div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="relative bg-[#4a4a4a] p-8 md:p-16 rounded-3xl border border-gray-800 shadow-xl overflow-hidden">
              ...
              <div className="space-y-6 text-lg text-gray-400 leading-relaxed font-medium">
                <p>
                  Mi nombre es <strong className="text-gray-100">Miguel Angel Di Virgilio</strong> y nombr├® esta empresa por mi hijo. Te cuento por qu├®.
                </p>
                <p>
                  Hace algunos a├▒os, mi esposa y yo nos enteramos que ├¡bamos a ser padres, de un var├│n. Fue una gran noticia ya que yo en ese momento empezaba un gran proyecto. Ese proyecto consist├¡a en el desarrollo de una empresa que se encargar├¡a de volver sue├▒os realidad, el sue├▒o de la casa propia. De a poco fui armando mi equipo, pidiendo mil presupuestos para poder dar con el proveedor que pueda darme precio y calidad.
                </p>
                <p>
                  El proyecto creci├│ y tambi├®n el embarazo. Lleg├│ el momento de elegir un nombre para mi primer hijo. Tuvimos much├¡simas idas y vueltas, no fue nada sencillo. Pero despu├®s de horas de debate elegimos el nombre <strong className="text-[#f27d26] text-xl">Apolo</strong>.
                </p>
                <p>
                  Al momento del nacimiento de mi hijo, decido que qu├® mejor que bautizar a mi gran proyecto como ├®l. As├¡ nace <strong className="text-gray-100">Apolo Di Virgilio Construcciones</strong>, una idea que creci├│ y hoy nos encuentra realizando varios proyectos simult├íneos.
                </p>
                <p className="text-gray-300 italic border-l-4 border-[#f27d26]/30 pl-6 py-2">
                  "Tal vez en un futuro mi familia pueda sumarse a este sue├▒o, ya que pr├ícticamente nacieron juntos."
                </p>
              </div>
            </div>
          </div>
        ...
        >
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-[#f27d26] text-[10px] uppercase tracking-[0.2em] font-semibold mb-6">Nuestra Misi├│n</p>
              ...
              <p className="text-lg text-gray-400 leading-relaxed font-medium">
                Somos una empresa constructora que busca mejorar la calidad de vida de sus habitantes mediante el desarrollo de proyectos inmobiliarios de alta calidad, ofreciendo oportunidades de inversi├│n seguras y rentables en una de las ciudades con mayor potencial tur├¡stico de la costa argentina.
              </p>
            </div>
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              { icon: <TrendingUp className="w-8 h-8" />, title: 'Rentabilidad', desc: 'Proyectos dise├▒ados para maximizar el retorno de inversi├│n de nuestros clientes.' }
            ].map((v, i) => (
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="max-w-3xl mb-24">
          ...
          <p className="text-xl text-gray-400 mb-12 leading-relaxed font-medium">
            Acompa├▒amos a nuestros clientes en cada etapa del proceso, desde la concepci├│n del proyecto hasta la entrega de llaves y el servicio posventa.
          </p>
        </div>
          ...
          {[
            {
              ...
              desc: "Planificaci├│n y ejecuci├│n integral de proyectos residenciales y comerciales con los m├ís altos est├índares de calidad."
            },
            {
              title: "Servicio Pos-Venta",
              desc: "Garant├¡a y mantenimiento especializado para asegurar que tu propiedad se mantenga impecable a trav├®s del tiempo."
            },
            {
              title: "Asesoramiento Legal",
              desc: "Transparencia absoluta en cada contrato y tr├ímite administrativo, brindando seguridad jur├¡dica a tu inversi├│n."
            }
          ].map((s, i) => (
            <motion.div 
              key={i} 
...
const Contacto = () => {
  return (
    <div className="pt-32 pb-24 bg-[#4a4a4a] min-h-screen border-t border-gray-800">
      <div className="max-w-7xl mx-auto px-6">
        <div className="max-w-3xl mb-24">
          <p className="text-[#f27d26] text-[10px] uppercase tracking-[0.2em] font-semibold mb-6">Estamos a su disposici├│n</p>
          <h1 className="text-6xl md:text-8xl mb-10 leading-tight tracking-tighter font-bold font-sans text-gray-100">
            Hablemos de su <br /><span className="text-[#f27d26] font-bold">Pr├│ximo Proyecto.</span>
          </h1>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-16 md:gap-24">
          ...
          >
            <div>
              <p className="text-gray-400 text-[10px] uppercase tracking-[0.2em] font-semibold mb-4">Tel├®fono</p>
            ...
            <div>
              <p className="text-gray-400 text-[10px] uppercase tracking-[0.2em] font-semibold mb-4">Ubicaci├│n</p>
    ...
    <div className="bg-[#3b3b3b] min-h-screen pt-32 pb-24 font-sans text-gray-100">
      ...
      <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="lg:col-span-7 space-y-16">
            ...
            <section className="bg-[#4a4a4a] p-8 md:p-12 rounded-3xl border border-gray-800 shadow-[0_10px_40px_-15px_rgba(0,0,0,0.05)]">
              <h2 className="text-gray-100 text-2xl font-bold mb-8 flex items-center gap-3">
                <Building2 className="text-[#f27d26]" /> Caracter├¡sticas Destacadas
              </h2>
            ...
            {project.financing && project.financing.length > 0 && (
              <section className="relative overflow-hidden bg-gradient-to-br from-[#423129] to-[#33261f] p-8 md:p-12 rounded-3xl border border-[#f27d26]/10 shadow-lg">
                ...
                <h2 className="text-[#f27d26] text-[10px] uppercase tracking-[0.3em] font-bold mb-4">Inversi├│n</h2>
                <h3 className="text-gray-100 text-3xl font-bold mb-8 relative z-10">Opciones de Adquisici├│n</h3>
        ...
        {project.gallery && project.gallery.length > 1 && (
          <div className="mt-32 border-t border-gray-700 pt-24">
            <div className="flex flex-col items-center text-center mb-16">
              ...
              <h2 className="text-4xl md:text-5xl font-black font-sans text-gray-100 mb-6">Galer├¡a del Proyecto</h2>
              <p className="text-gray-500 max-w-2xl text-lg font-medium">Hac├® click en cualquier imagen para ampliarla y explorar cada detalle arquitect├│nico.</p>
            </div>
        ...
        {id && mapQueries[id] && (
          <div className="mt-32 border-t border-gray-700 pt-24">
            <div className="flex flex-col items-center text-center mb-16">
              <p className="text-[#f27d26] text-[10px] uppercase tracking-[0.3em] font-bold mb-4">Ubicaci├│n</p>
              <h2 className="text-4xl md:text-5xl font-black font-sans text-gray-100 mb-6">┬┐D├│nde se encuentra?</h2>
            </div>
...
const ProcesoCompra = () => {
  const steps = [
    { icon: <Eye className="w-8 h-8" />, title: 'Descubr├¡ el Proyecto', desc: 'Conoc├® nuestros emprendimientos Ares 22, Viggo 91 o Delfos 83 a trav├®s de nuestras redes o sitio web.' },
    { icon: <MessageCircle className="w-8 h-8" />, title: 'Consult├í por WhatsApp', desc: 'Escribinos al +54 9 2262 506588 para recibir toda la informaci├│n del proyecto que te interesa.' },
    { icon: <Users className="w-8 h-8" />, title: 'Reuni├│n Presencial', desc: 'Coordinamos un encuentro para conocernos, visitar la obra y resolver todas tus consultas.' },
    { icon: <Banknote className="w-8 h-8" />, title: 'Se├▒a de Reserva', desc: 'Reserv├í tu unidad con una se├▒a del 20%. Asegur├í tu lugar en el emprendimiento.' },
    { icon: <FileText className="w-8 h-8" />, title: 'Firma de Contrato', desc: 'Formalizamos la operaci├│n con un contrato transparente. Sin letra chica ni sorpresas.' },
    { icon: <KeyRound className="w-8 h-8" />, title: 'Entrega del Departamento', desc: 'Recib├¡ las llaves de tu nuevo departamento con todas las terminaciones de calidad Apolo.' },
    { icon: <CreditCard className="w-8 h-8" />, title: 'Pago de Cuotas', desc: 'Continu├í abonando las cuotas restantes en PESOS. Planes de hasta 120 cuotas disponibles.' },
    { icon: <TrendingUp className="w-8 h-8" />, title: 'Rentabiliz├í tu Inversi├│n', desc: 'Gener├í ingresos a trav├®s del alquiler temporario o permanente, o revend├® con ganancia.' }
  ];
      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-xl text-gray-400 font-medium leading-relaxed max-w-3xl mx-auto">
            Invertir en un departamento desde el pozo es m├ís simple de lo que pens├ís. Te acompa├▒amos en cada etapa del proceso.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-gray-400 text-lg mb-10 max-w-2xl mx-auto font-medium">Contactanos hoy y empez├í a construir tu patrimonio con la seguridad y respaldo de Apolo Construcciones.</p>
