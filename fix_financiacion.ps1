$content = Get-Content -Path "src\App.tsx" -Encoding UTF8
$startLine = 831
$endLine = 933
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-stretch">
          ...
          >
            ...
            <Link to="/contacto" className="w-full py-4 bg-gray-900 hover:bg-black text-white font-black rounded-xl transition-all duration-300 text-sm uppercase tracking-widest text-center">
              Consultar Detalles
            </Link>
          </motion.div>
...
$updatedContent = $content[0..($startLine-2)] + $newFinanciacion + $content[$endLine..($content.Length-1)]

# Save back to the file
$updatedContent | Set-Content -Path "src\App.tsx" -Encoding UTF8
